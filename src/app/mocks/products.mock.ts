import { ProductGroup } from '../interfaces/product.interface';
...
export const productsListData: ProductGroup[] = [
  ...
  },
  {
    ...
    images: [
      ...
      'assets/products/id-1-2.jpg',
      'assets/products/id-1-3.jpg',
      'assets/products/id-1-4.jpg',
      'assets/products/id-1-5.jpg',
      'assets/products/id-1-6.jpg',
    ],
    quanitity: 4,
  },
  {
  ...
  },
  {
    ...
    rating: 4.9,
    description_long:
      ' ტყავის თუთუნის ჩანთა, აუცილებელი ნივთების უკეთ ორგანიზებისთვის. იტევს: თუთუნის პაკეტს, შესახვევ ქაღალდებს, ფილტრებს და სანთებელას',
    additional_info:
    ...
    images: [
      ...
      'assets/products/id-5-2.jpg',
      'assets/products/id-5-3.jpg',
    ],
    quanitity: 4,
  },
];
